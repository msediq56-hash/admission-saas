...
const AS_LEVEL_GRADES = ["A", "B", "C", "D", "E"];

export default function ASLevelEditor({ config, effect, effectMessage, onChange, onEffectChange, onEffectMessageChange }: RuleEditorProps) {
  return (

...
const O_LEVEL_GRADES = ["A*", "A", "B", "C", "D", "E", "F", "G"];

export default function OLevelEditor({ config, effect, effectMessage, onChange, onEffectChange, onEffectMessageChange }: RuleEditorProps) {
  return (
